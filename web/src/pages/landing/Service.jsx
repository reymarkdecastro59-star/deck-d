...
export default function Service() {
  ...
  return (
    <section id="features" className="relative overflow-hidden" style={{ background: '#05061a' }}>
      {/* 1. Texture */}
      <img
        src={bgFeatures}
        alt=""
      ...
      <div
        ...
        style={{ height: '140px', background: 'linear-gradient(to top, #0A0918, transparent)' }}
      />

      {/* Content */}
      <div className="service-content relative z-10 w-full" style={{ padding: '100px 84px' }}>
        {/* Header */}
        <motion.div
